...
animal1 = Animal.create!(city: "Bordeaux", specie: "Sheep", user: leo, price: 48, name: "Nathalie", address: "Zuccoti Park, New York",description:"Mouton extrêmement cool, et mignon. Peut remplacer des baby sitters en gardant vos enfants.")
...
animal1 = Animal.create!(city: "Paris", specie: "Monkey", user: narcisse, price: 13, name: "Bongo", address: "World Trade Center, New York",description:"Singe, multifonction, peut être loué pour des tests de laboratoires ou pour des pictures instagram")
